...
function Portfolios() {
  const data = [
    {
      url: "https://s3-alpha-sig.figma.com/img/09e8/0e3e/dd6502d1725666c5962ca361c8bf8169?Expires=1681084800&Signature=ZPBfG6xlrgnRaKc5Z73-XY4EwhZOgHbACaDwyUrT98Iyl-Hc3L1hpQqcWh8nzkOxEswtN3U0~OZrskmNnnnZUmjuDRrIl3ITaq4jG3inSu8~hmSIebIjUrebkWmTDNAnn1rBBeUbLGEjm4MT7dm0s0-RVhiG9fraQyP7yzAuCp9MWF~jwoWw4ght2EqGp9if~yp3ZmGllgsmqDwKcyElWCJwVdI7DRtmJc5UGrL0GDpbhhP8ajgxOvsLx5FgH4D5aDkX8~fxCWtiti-t5NL6IneLqBxN38ABv3IGo6oR6D0pYWMNw4oCq1NhepuidUPs~pUxMOxt5z-62OuqhnZY4Q__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4",
      ...
      read: "Read more",
      icon: "fa-solid",
      icon2: "fa-arrow-up-right-from-square",
    },
    {
      url: "https://s3-alpha-sig.figma.com/img/3fd7/2a5d/742460a781e3449bd3d7e927290004f7?Expires=1681084800&Signature=k0lDI643QYenErQUvPAQdXVt3NdNAiEcL6Xu9H0VJKhUDcK5QtwmAoLfxfsZSoA9cSzA7vzuvmirjRM8dA4ZhYpi5F2qanwdxrkTfrMiPJUfUgOjItuNVUFWtZyDPNHC0YZjGNCd8ukg0y4bWTyYbywU0EuFep-MIpsQC87dNT1qUAtSn3O9cafecotfxad6xq-njBQIeAYnEbRnfcAiSRYiuwTpDPw-v96olD7JrsQFHJuxMYVxasP1zCbRPzLmrWd4bes5SJOVb2txvdrNVrkRvCSyzQJCTcpRmGqZDPH-kPyQGGV6k8Ky4dOXAiPLkCps6xITqhjfl8Ps8nSfoQ__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4",
      logo: "There is more than you know",
      info: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard",
      read: "Read more",
      icon: "fa-solid",
    ...
    {
      url: "https://s3-alpha-sig.figma.com/img/10f9/42af/fdfb5ecf5403141a7530999eeb6fc544?Expires=1681084800&Signature=dm7T4P5yYiPp62bQAiI~5wK4AogmNqGP25Tfm7mzCkkbIh-7JjF4n6rPzWCZ0mdL5hPrL1LAjnH5tPW1Hft9uFnooMfV1abBjEphBNjvcdKw~kyvXQjKReuUSbHteiUQ2mtzfTKsmGscm9OxjCOdLRv9lyy-wcTn7gBAzbbwQN2jxujTRoPRAA33FttHB91~U7~Njmc-KHErx5mwLsZOMhnkiXxwgak5qj-T~fq6p2RIpHKLCHV0Pius7n8XlowuGTOLyIQf4cC4TPbpYJiMw1Uxh-pWRmlhrwqhL6UZhMKzp790Al0gZGKFxr4tgVNPRWm4airUXZM2hdO~UE26bQ__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4",
      logo: "There is more than you know",
      info: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard",
      read: "Read more",
      icon: "fa-solid",
  ...
  return (
    <>
    <section className="Portfolios-logo">
          ...
          {data.map((x) => (
            <>
              <div className="Portfolios-item">
                <div className="Portfolios-photo">
                  <img src={x.url} alt="" />
                </div>
                ...
                <div className="Portfolios-text">
                  <h3>{x.logo}</h3>
                  <p>{x.info}</p>
                  <div className="Portfolios-read">
                    <p>{x.read}</p>
                    <span>
                      <i className={x.icon + " " + x.icon2}></i>
                    </span>
                  </div>
                </div>
              </div>
