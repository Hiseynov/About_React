          ...
          <section className="main-top">
            <div className="main-top__container">
              <div className="main-top__left">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQr9_UDnt8fRiSUgiLiI5BIiFTwCZEruYZpwA&usqp=CAU"
                  alt="User"
                />
              </div>
              <div className="main-top__right">
                <p>
                  ...
                  <span className="orange">Backend</span> and{" "}
                  <span className="orange">Android</span>  Programmer and{" "}
                  <span className="orange">UI/UX</span>  Designer
                </p>
              </div>
            </div>
          </section>
