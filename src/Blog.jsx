...
//    const list2 = [1,2,3,4,5,6,7]
    const data = [
        ...
        {
            url:'https://s3-alpha-sig.figma.com/img/9d1d/813e/2455989085b706d84d051ace7522b4b0?Expires=1681084800&Signature=Y~pnoBmLy~9TPnrU0Ix5SFeWcOU65u5-QJNcg2y~3GQmFH4JKe0yOhSVhshsr8ddCZPewk67aWKz5RGmTNFK-fCS2d5RA6a2uQyi3wF~uD5P~Ryfn~L86idoxxbYMyOzWp3zvhcvED~C-b6s0e5LdsSZz5BpacE0SnZ-RaVlSXbeF9CRbI7qsGUqLn6OIJ9nMy0S0Vl0gQTsPClNxeaZ2kI0S6ysw6BeJIJL9Cxp1l-pn7sJv2sB4iE-iT3XCb3R~-pwAQoed1nE0RRfPUYYQ~iqcGvQbS8qgKPdgx8-CReQAqHs8Cd2X1~8VTumslfAUlOqi76Nx8VBZDTbD~2zFA__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4',
            logo:'There is more than you know',
            info:"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard",
            read:'Read more',
            icon:'fa-solid',
  ...
  return (
    ...
    <section className='blog'>
        ...
        data.map(x=> 
            ...
            <div className="blog-read">
                <p>{x.read}</p>
                <span><i className={x.icon + ' ' +  x.icon2}></i></span>
            </div>
            </div>
    ...
    {/* <ul>
        {list2.map(item=> <button className={`${selected==item?'active':''}`} onClick={()=> setSelected(item)} style={{padding: '10px'}}>{item}</button>)}
    </ul> */}
